(define (problem ProblemaRepartidor1)
    ...
    (:init 
	    ...
	    (= (distancia almacen-destino almacen) 120000)
            (= (distancia ciudad2 ciudad1) 20000)
            (= (distancia ciudad3 ciudad1) 30000)
            (= (distancia ciudad4 ciudad1) 50000)
	    (= (distancia ciudad5 ciudad1) 70000)
	    (= (distancia almacen-destino ciudad1) 100000)
	    (= (distancia ciudad3 ciudad2) 10000)
	    (= (distancia ciudad4 ciudad2) 30000)
	    (= (distancia ciudad5 ciudad2) 50000)
	    (= (distancia almacen-destino ciudad2) 80000)
	    (= (distancia ciudad4 ciudad3) 20000)
	    (= (distancia ciudad5 ciudad3) 40000)
	    (= (distancia almacen-destino ciudad3) 70000)
	    (= (distancia ciudad5 ciudad4) 20000)
	    (= (distancia almacen-destino ciudad4) 50000)
	    (= (distancia almacen-destino ciudad5) 30000))
